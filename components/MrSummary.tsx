  ...
  return (
    <div className="bg-white dark:bg-brand-surface rounded-lg shadow-xl h-full flex flex-col">
       <div className="p-4 border-b border-gray-200 dark:border-brand-primary">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Reviewing MR !{mrDetails.mrIid}</h2>
      </div>
      <div className="p-6 space-y-4 flex-grow flex flex-col">
        <div className="flex-grow space-y-4">
            <div>
                <h3 className="font-bold text-gray-900 dark:text-brand-text break-words">{mrDetails.title}</h3>
                <p className="text-sm text-gray-500 dark:text-brand-subtle mt-1">by {mrDetails.authorName}</p>
            </div>
            <div className="flex items-center text-sm font-mono bg-gray-100 dark:bg-brand-primary/50 p-3 rounded-md">
             ...
             <a 
              ...
              className="block w-full text-center bg-gray-100 dark:bg-brand-primary hover:bg-gray-200 dark:hover:bg-brand-primary/70 text-gray-600 dark:text-brand-subtle font-bold py-2 px-4 rounded-md transition-colors"
            >
              View on GitLab
            </a>
        </div>
        ...
        <div className="flex-shrink-0">
            <button
            onClick={onNewReview}
            className="w-full flex items-center justify-center bg-brand-secondary hover:bg-red-600 text-white font-bold py-3 px-4 rounded-md transition-colors"
            >
            <PlusIcon />
