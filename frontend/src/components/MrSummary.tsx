      ...
      <div className="p-4 flex-grow flex flex-col min-h-0 bg-white dark:bg-[#18191d]">
        <div className="flex-grow flex flex-col min-h-0 space-y-4">
          <div className="flex items-center space-x-2 text-[10px] font-mono bg-[#fbfbfb] dark:bg-[#1f1e24] p-2 rounded border border-[#dbdbdb] dark:border-[#404040] flex-shrink-0">
            <span
              className="text-[#1f75cb] dark:text-[#428fdc] font-bold truncate max-w-[80px]"
            ...
            <span
              className="text-[#444444] dark:text-[#a1a1aa] font-medium truncate max-w-[80px]"
          ...
          <div className="flex-grow flex flex-col min-h-0">
            <div className="flex items-center justify-between mb-1.5">
              <h4 className="text-[10px] font-bold uppercase tracking-wider text-[#444444] dark:text-[#a1a1aa]">
                Files
              </h4>
              <span className="text-[10px] font-bold text-[#444444] dark:text-[#a1a1aa]">
          ...
          <div className="pt-2 border-t border-[#dbdbdb] dark:border-[#404040]">
